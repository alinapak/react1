...
return (
  <>
  {/* uzvadinam animal kad suprastumem patys */}
    {animals.map((animal) => (
      // propsas= {animal} ir tada paduodam: propsas = {animal.kazkasKoNorim}
      <Animal key={animal.id} photo={animal.img} pavad={animal.animal} />))}
  </>
